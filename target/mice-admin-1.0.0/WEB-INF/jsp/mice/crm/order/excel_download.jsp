...
String filename = "EVENT_ORDER_"+day+"_"+hour;


response.setHeader("Content-Type","application/vnd.hwp;charset=utf-8");
response.setHeader("Content-Disposition","attachment;filename="+filename+".doc");
response.setHeader("Content-Description", "EVENT ORDER");
...
String host_name = "http://"+request.getServerName()+":"+request.getServerPort()+"/";
...
<td>
		...
		<tr>
		  <td width="33%"><img src="<%=host_name%>/images/mice/new/logo.jpg" alt="" style="height:55px;">
		  <td width="33%" align="center"><p class="bigtitle">EVENT  ORDER</p></td>
		  <td width="33%" align="right" >
			  
			  <p>EO No:${getOrder.order_no}<br/>
