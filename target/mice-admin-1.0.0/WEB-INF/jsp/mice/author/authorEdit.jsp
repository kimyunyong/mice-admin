...
<section id="contentArea">
	<h3>시스템관리 <span>></span>권한관리<span>></span>수정</h3>
	<section class="sect_nonetit">
		<h4>직원등록</h4>
			<form:form commandName="authorManage" action="/sec/ram/EgovAuthorUpdate.do" method="post" >
							...
							<tr>
								...
								<td class="text_left">
									<div class="inputBox_S">
										...
										<input type="text" name="authorCode" id="authorCode" size="40" value="<c:out value='${authorManage.authorCode}'/>" readonly>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="text_left">
									<div class="inputBox_S">
										...
										<input type="text" name="authorNm" id="emplyrNm" value="<c:out value='${authorManage.authorNm}'/>" maxLength="50" size="40" required>
									</div>
								</td>
							</tr>				
							<tr>
							...
							<tr>
								...
								<td class="text_left">
									<div class="inputBox_S">
										...
										<input type="text" name="authorCreatDe" id="authorCreatDe" value="<c:out value='${authorManage.authorCreatDe}'/>" readonly  required>
									</div>
								</td>
							</tr>
						</tbody>
