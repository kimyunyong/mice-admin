...
public class UserManageVO extends UserDefaultVO{
	...
	public void setEmplyrNm(String emplyrNm) {
		try
		{
			this.emplyrNm = com.mice.common.encrypt.AESGenerator.encrypt(emplyrNm);
		}catch(Exception ex){
	...
	public String toString() {
		return "UserManageVO [decrypt=" + decrypt + ", oldPassword="
				+ oldPassword + ", sbscrbDe=" + sbscrbDe + ", uniqId=" + uniqId
				+ ", userTy=" + userTy + ", areaNo=" + areaNo + ", brth="
				+ brth + ", detailAdres=" + detailAdres + ", emailAdres="
				+ emailAdres + ", emplNo=" + emplNo + ", emplyrId=" + emplyrId
				+ ", emplyrNm=" + emplyrNm + ", emplyrSttusCode="
				+ emplyrSttusCode + ", fxnum=" + fxnum + ", groupId=" + groupId
				+ ", homeadres=" + homeadres + ", homeendTelno=" + homeendTelno
				+ ", homemiddleTelno=" + homemiddleTelno + ", ihidnum="
				+ ihidnum + ", insttCode=" + insttCode + ", mberTy=" + mberTy
				+ ", moblphonNo=" + moblphonNo + ", ofcpsNm=" + ofcpsNm
				+ ", offmTelno=" + offmTelno + ", orgnztId=" + orgnztId
				+ ", password=" + password + ", passwordCnsr=" + passwordCnsr
				+ ", passwordHint=" + passwordHint + ", sbscrbDeBegin="
				+ sbscrbDeBegin + ", sbscrbDeEnd=" + sbscrbDeEnd
				+ ", sexdstnCode=" + sexdstnCode + ", zip=" + zip + ", subDn="
				+ subDn + ", authorCode=" + authorCode + ", permission="
				+ permission + ", team_idx=" + team_idx + ", position="
				+ position + ", reg_id=" + reg_id + "]";
	}
