...
<form:form commandName="passwordChgVO" action="/uss/umt/EgovEntrprsPasswordUpdt.do?action=entRegist" name="passwordChgVO" method="post" >
	...
	<table class="adm_tbl2">
		...
		<tbody>
			<tr>
				...
				<td class="left">
					<div class="inputBox_S">
						...
						<input class="readonly" name="entrprsmberId" id="entrprsmberId" title="사용자아이디" type="text" size="20" value="<c:out value='${entrprsManageVO.entrprsmberId}'/>"  maxlength="20" readonly/>
	                    <input name="uniqId" id="uniqId" title="uniqId" type="hidden" size="20" value="<c:out value='${entrprsManageVO.uniqId}'/>"/>
	                    <input name="userTy" id="userTy" title="userTy" type="hidden" size="20" value="<c:out value='${entrprsManageVO.userTy}'/>"/>
					</div>
				</td>
			</tr>
			<tr>
				<th scope="row">기존 <br class="mobile_none">비밀번호</th>
				<td class="left">
					<div class="inputBox_S">
			...
			<tr>
				<th scope="row">비밀번호 <br class="mobile_none">확인</th>
				<td class="left">
					<div class="inputBox_S">
	...
	<div class="btn_area">
		<div class="center">
			...
			<a href="<c:url value='/uss/umt/EgovEntrprsMberSelectUpdtView.do'/>?action=entRegist&selectedId=<c:out value='${entrprsManageVO.uniqId}'/>" role="button" class="btn1 clr_Wgray">뒤로가기</a>
