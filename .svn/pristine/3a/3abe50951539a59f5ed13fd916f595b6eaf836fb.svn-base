        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><img src="<c:url value='/images/mice/common/er_logo.jpg' />" width="379" height="57" alt="에러로고이미지" /></td>
              </tr>
              <tr>
                <td><br />
                  <br /></td>
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td width="74" rowspan="2" align="center"><img src="<c:url value='/images/mice/common/er_icon.png' />" width="74" height="74" alt="경고이미지" /></td>
