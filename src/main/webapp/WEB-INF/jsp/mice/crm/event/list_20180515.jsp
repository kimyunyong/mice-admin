...
$(document).ready(function(){
	...
	var str1 = "form[name=form] input[name=searchEventName]";
		...
		<table  class="adm_tbl2 " summary="명함관리에  관한 테이블입니다.번호, 이미지, 제목, 등록일, 등록자 정보의 내용을 담고 있습니다.">
			...
			<tbody>
				...
				<td colspan="5" class="left">	
							...
							<input type="radio" name="search_manager_event" value=""  <c:if test="${fn:length(vo.search_manager_event) <= 0}"> checked </c:if>/>모두
...
<!-- 				<th scope="row">장소</th>
			...
			<tr>
				...
				<td class="left">
						...
						<input name="searchJoinPersonalMaxCount" type="numberr" value="${vo.searchJoinPersonalMaxCount }"   class="wd40per">
				</td>
...
<!-- 
		<div class="result_desc">
			<dl>
				<dt>전체참가자수 </dt>
				<dd><fmt:formatNumber>${SummaryTotalParticipant }</fmt:formatNumber>명</dd>
			</dl>

			<dl>
				<dt>외국인수</dt>
				<dd><fmt:formatNumber>${SummaryForeigner }</fmt:formatNumber>명</dd>
			</dl>

			<dl>
				<dt>내국인수</dt>
				<dd><fmt:formatNumber>${SummaryNational }</fmt:formatNumber>명</dd>
			</dl>

			<dl>
				<dt>전시부스</dt>
				<dd><fmt:formatNumber>${SummaryBooth }</fmt:formatNumber>개	</dd>
			</dl>
			<dl>
				<dt>전시면적</dt>
				<dd><fmt:formatNumber>${SummaryExhibitionScale }</fmt:formatNumber>m<sup>2</sup></dd>
			</dl>

			<dl>
				<dt>견적금액</dt>
				<dd><fmt:formatNumber>${SummaryEstimateCost }</fmt:formatNumber>원</dd>
			</dl>

			<dl>
				<dt>임대매출</dt>
				<dd><fmt:formatNumber>${SummaryRentCost }</fmt:formatNumber>원</dd>
			</dl>


			<dl>
				<dt>식음매출</dt>
				<dd><fmt:formatNumber>${SummaryFoodCost }</fmt:formatNumber>원</dd>
			</dl>

			<dl>
				<dt>AV및렌탈매출</dt>
				<dd><fmt:formatNumber>${SummaryAVCost }</fmt:formatNumber>원</dd>
			</dl>

			<dl>
				<dt>관리비매출</dt>
				<dd><fmt:formatNumber>${SummaryManageCost }</fmt:formatNumber>원</dd>
			</dl>

			<dl>
				<dt>총매출</dt>
				<dd><fmt:formatNumber>${SummaryTotalCost }</fmt:formatNumber>원</dd>
			</dl>
