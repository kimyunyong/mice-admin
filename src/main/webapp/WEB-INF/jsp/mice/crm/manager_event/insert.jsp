...
$(document).ready(function(){
	...
	$('#btnEventManagerSave').on('click',function(){
	    ...
	    $.ajax({
	        url: '/crm/manager_event/insert_action.do',
	        type: 'POST',
	        data:params,
		...
		<form name="eventManagerForm" id="eventManagerForm" method="post" enctype="multipart/form-data">
			...
			<tbody>
				<tr>
					...
					<td class="left">
						...
						<input name="cate_name" id="cate_name" type="text" size="100" style="ime-mode:active" maxlength="50"/>
