...
public class EgovCalRestdeManageController {
	...
	public String insertRestde (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if   (restde.getRestdeDe() == null
            ...
            return "mice/crm/event/calender/holiday_create";//"egovframework/com/sym/cal/EgovRestdeRegist";
    	}
	...
	public String selectRestdeList (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        return "mice/crm/event/calender/holiday_list";//"egovframework/com/sym/cal/EgovRestdeList";
	}
	...
	public String updateRestde (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if (sCmd.equals("")) {
            ...
            return "mice/crm/event/calender/holiday_create";//"egovframework/com/sym/cal/EgovRestdeModify";
