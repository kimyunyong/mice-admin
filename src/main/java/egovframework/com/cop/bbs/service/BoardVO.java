...
public class BoardVO extends Board implements Serializable {
    ...
    /** 사이트코드 */
    private int searchTp = 0;
    
    /** 언어 */
    private String searchLang = "";
    
    /**
	 * 사이트 타입코드 0:공통, 1:HICO, 2:CVB
	 */
	private int siteTp = 0;
	
	private String bbsLang = "";
	
	
	/**
	 * siteTp attribute 값을 설정
	 */
	public void setSiteTp(int code){
		this.siteTp = code;
	}
    ...
    public void setSearchTp(int code){
    	this.searchTp = code;
    }
    public int getSearchTp(){
    	return this.searchTp;
    }
    
    public void setSearchLang(String lang){
	...
	public String getBbsLang() {
		return bbsLang;
	}

	public void setBbsLang(String bbsLang) {
		this.bbsLang = bbsLang;
	}
}
